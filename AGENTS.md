...
>
> - **修改代码后必须同步更新本 AGENTS.md 与 [README.md](./README.md)** — 功能增删、架构变更、部署方式变更都需要在两份文档中体现
> - [README.md](./README.md) 面向**人类用户**（功能介绍、运行方法、部署步骤），AGENTS.md 面向 **AI 代理**（架构、代码组织、开发约定），两份文件**不可互相替代**
